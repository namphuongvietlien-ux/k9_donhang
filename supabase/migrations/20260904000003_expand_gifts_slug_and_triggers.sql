-- Gắn quà theo slug (không chỉ product_id), bỏ qua nếu đã có dòng tặng,
-- và tự chạy khi insert order_items / dispatch items.
...
GRANT EXECUTE ON FUNCTION public.trg_expand_order_gifts_on_item() TO authenticated, service_role;
