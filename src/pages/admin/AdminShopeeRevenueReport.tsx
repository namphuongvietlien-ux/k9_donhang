...
interface OrderWithFees extends EcommerceOrder {
  ...
  feeCalculation: ReturnType<typeof calculateShopeeFeesWithQuantity>;
}

const AdminShopeeRevenueReport = () => {
  ...
  const handleExportCSV = () => {
    ...
    const rows = filteredOrders.map((order) => [
      ...
      order.feeCalculation.paymentFee,
      order.feeCalculation.fixedFee,
      order.feeCalculation.voucherXtraFee,
      DEFAULT_SHOPEE_FEE_CONFIG.infrastructureFee,
      order.feeCalculation.piShipFeeAmount,
    ...
    link.setAttribute("download", `shopee-revenue-report-${dateStr}${statusStr}.csv`);
  ...
  return (
    <AdminLayout>
      <SEO title="Báo cáo doanh thu Shopee - Admin" description="Báo cáo phí sàn và doanh thu từ đơn hàng Shopee" />
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              ...
              <p className="text-muted-foreground mt-1">
                Tính toán phí sàn và doanh thu từ các đơn hàng Shopee
              </p>
            </div>
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow>
                        ...
                        <TableHead className="text-right">Phí thanh toán</TableHead>
                      ...
                      {filteredOrders.map((order) => (
                        <TableRow key={order.id}>
                          ...
                          <TableCell className="text-right text-blue-600">
                            {formatPrice(order.feeCalculation.paymentFee)}
                          </TableCell>
                          <TableCell className="text-right text-orange-600">
                            {formatPrice(order.feeCalculation.fixedFee)}
                          </TableCell>
...
export default AdminShopeeRevenueReport;
