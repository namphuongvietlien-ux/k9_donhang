...
const generateDescription = (
  ...
  return "Chính sách bảo mật thông tin cá nhân của khách hàng. Cam kết bảo vệ quyền riêng tư và thông tin của bạn.";
};
...
const PrivacyPolicy = () => {
  ...
  const pageTitle = pageContent?.title || "Chính sách bảo mật";
  const description = generateDescription(pageContent?.subtitle, content.sections);
  const keywords = "chính sách bảo mật, privacy policy, bảo vệ thông tin cá nhân, quyền riêng tư, bảo mật dữ liệu";
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-serif font-bold mb-4">
                {pageContent?.title || "Chính sách bảo mật"}
              </h1>
